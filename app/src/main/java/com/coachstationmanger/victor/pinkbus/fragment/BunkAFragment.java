...
import com.coachstationmanger.victor.pinkbus.SeatActivity;
...
public class BunkAFragment extends Fragment {
     ...
     * @return A new instance of fragment BunkAFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static BunkAFragment newInstance(String param1, String param2) {
        BunkAFragment fragment = new BunkAFragment();
    ...
    public void CustomDialog(final View view, final Button idSeat)
    {
        ...
        //
        final String dialog_id_seat=idSeat.getText().toString()+"A";
    ...
    public void onButtonPressed(SeatDetails seatDetails) {
        if (mListener != null) {
            mListener.onBunkAFragmentInteraction(seatDetails);
        }
    }
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof OnBunkAFragmentInteractionListener) {
            mListener = (OnBunkAFragmentInteractionListener) context;
        } else {
    ...
    public interface OnBunkAFragmentInteractionListener {
        // TODO: Update argument type and name
        void onBunkAFragmentInteraction(SeatDetails seatDetails);
    }
}
